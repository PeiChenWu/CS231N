...
class COCOEvaluator(DatasetEvaluator):
    ...
    def __init__(self, dataset_name, cfg, distributed, output_dir=None):
        ...
        try: #Visu added hack to generate json file all the time
            delattr(self._metadata, 'json_file') ##visu HACK
        except:
            pass
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        metrics = {
            "bbox": ["AP", "AP50", "AP75", "APs", "APm", "APl", "f1AP", "f1AP50", "f1AP75", "f1APs", "f1APm", "f1APl"],
            "segm": ["AP", "AP50", "AP75", "APs", "APm", "APl", "f1AP", "f1AP50", "f1AP75", "f1APs", "f1APm", "f1APl"],
        ...
        assert len(class_names) == precisions.shape[3]
